    ...
    <main class="bg-pink-200">
        <div class="relative min-h-screen flex ">
            <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
                <div class="xl:w-3/5 h-full hidden md:flex flex-auto pt-14 justify-center p-5 overflow-hidden bg-sun text-white bg-no-repeat bg-cover relative">
                ...
                <!-- Rules -->
                <div class="bg-gradient-to-b from-my-orange-light to-sun px-10 text-center py-10 mt-5 sm:text-2xl font-bold md:hidden">
                    <p class="text-white text-3xl font-bold">So You Would Like To Become A Guide ...</p>
                    <div class="sm:text-sm xl:text-md text-gray-200 text-center pt-10">
                        <p class="text-gray-darker font-bold text-xl mb-5">1. Check that your profile is complete.</p>
                        <p class="text-gray-darker font-bold text-xl mb-5">2. Fill in the form below.</p>
                        <p class="text-gray-darker font-bold text-xl mb-5">3. Your application will then be reviewed.</p>
                        <p class="text-gray-darker font-bold text-xl mb-3">4. If your application is accepted :</p>
                        <p class="text-gray-dark font-semibold mb-5 text-lg">- You will receive a confirmation email</p>
                        <p class="text-gray-dark font-semibold mb-5 text-lg">- New features will be added to your account</p>
                ...
                <!-- Form part -->
                <div class="w-full md:flex md:h-full w-3/5 xl:w-11/12 p-8 md:p-5 lg:p-5 lg:pt-10 justify-center sm:rounded-lg md:rounded-none bg-white">
                        ...
                        @csrf
                            <div class="mb-4 md:flex md:justify-around">
                                <div class="mb-4 md:mr-2 md:mb-0">
                                    <label for="languages" class="block mb-2 text-base font-bold text-gray-700">
                                        Languages*
                                    </label>
                                ...
                                <div class="md:ml-2 mb-4">
                                    <label class="block mb-2 text-base font-bold text-gray-700" for="categories">
                                        Your interests*
                                    </label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-base font-bold text-gray-700" for="offers">
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-base font-bold text-gray-700" for="motiv">
                                    Your motivation(s)*
                                </label>
                            ...
                            <div class="mb-6 text-center">
                                <button  type="submit" class="px-10 py-2 font-bold text-white bg-last rounded-full hover:text-sun focus:outline-none focus:shadow-outline">
                                    Submit
                                </button>
                            </div>
                        </form>
