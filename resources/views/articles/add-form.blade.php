<x-app-layout>
    ...
    <main>
            <h3 class="font-extrabold text-center text-3xl text-last pt-5">Share what you like about {{ $user->city }}. <br>What is your favorite spot?</h3>
            <div class="flex justify-center">
                <div class="bg-gray-lighter rounded-md py-5 px-5 overflow-x-hidden md:my-5 md:mx-5">
                    <form method="POST" action="{{ route('add_article') }}" enctype="multipart/form-data" class="grid grid-cols-1 justify-items-center">
                        @csrf
                        @method('POST')   
                        ...
                        <div class="grid">
                            <label for="description" class="pt-5 font-semibold text-gray-darker">Description*</label>
                        ...
                        <div class="pt-8">
                            <label for="pictures" class="pr-3 font-semibold text-gray-darker">Add pictures*</label> 
                            <input type="file" name="pictures[]" id="pictures" multiple class="lg:text-base text-gray-dark rounded-lg mt-3">
                            <span class="text-gray-darker block md:inline">(Add at least 2 photos)</span>
